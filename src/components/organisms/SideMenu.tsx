    ...
    <>
      <aside
        ...
        className={`
                ...
                overflow-auto  z-30 h-full max-h-[100vh] laptop:w-[26vw] desktop:w-[21rem] fixed top-0 left-0 `}
      >
        {" "}
        {/*  overflow-y-scroll  */}
        <div className="">
          <div className="">
            <ul className="flex justify-between w-[17rem] h-10 mx-auto  font-tommyMedium text-xl text-platinum items-center mt-8 widescreen:mt-10">
              ...
              <a
                href="/blog"
                className={`${
                  pathname.includes("/blog") && "bg-cerisedark"
                } cursor-pointer p-2 rounded-t-md rounded-bl-md`}
              >
                <li
                  className=""
              ...
              <a
                ...
                className={`${
                  ...
                  "bg-cerisedark cursor-pointer transition-colors"
          ...
          <ul
            className={`${
              stateSideMenu === "opening" ||
              stateSideMenu === "open" ||
              stateSideMenu == "hiding"
                ? "relative"
              ...
              <>
                ...
                {POST_CATEGORIES.map((cat) => (
                  <div key={cat.title} className="my-2">
                    ...
                    {POSTS[cat.title].map((POST) => (
                      <ProjectLink
                        key={POST.title}
                        sideMenuHandler={sideMenuHandler}
                        to={`/portfolio/${POST.link}`}
                      >
                        {POST.title}
                      </ProjectLink>
                    ))}
