                    ...
                    <div className="relative h-full aspect-video rounded-lg">
                        {images && (
                            <img
                                ...
                                className={`absolute  w-full  rounded-lg object-cover aspect-video transition-opacity opacity-100 ease-in-out ${imageLoaded ? "opacity-0" : "opacity-100"} `}
                            />
                        )}
                        {images && (
                            <img
                                ...
                                className={`absolute w-full rounded-lg object-cover aspect-video transition-opacity ease-in-out ${imageLoaded ? "opacity-100" : "opacity-0"}`}
                            />
                        )}
                    </div>
                </div>
